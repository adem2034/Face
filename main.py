...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'ademdrici2020@gmail.com' ")
...
message3 = tk.Label(window, text="Face System" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
head2 = tk.Label(frame2, text="                       nouvelles inscriptions                       ", fg="black",bg="#00fcca" ,font=('comic', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                            Registered                                       ", fg="black",bg="#00fcca" ,font=('comic', 17, ' bold ') )
head1.place(x=0,y=0)
...
lbl3 = tk.Label(frame1, text="Présence",width=20  ,fg="black"  ,bg="#c79cff"  ,height=1 ,font=('comic', 17, ' bold '))
